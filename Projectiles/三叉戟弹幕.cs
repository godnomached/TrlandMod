...
namespace TrlandMod.Projectiles
{
    ...
    public class 三叉戟弹幕 : ModProjectile
    {
        ...
        public override Color? GetAlpha(Color lightColor) { return new Color(255, 255, 255, 0); }
        ...
        public override void AI()
        {
            ...
            Dust dust = Dust.NewDustPerfect(dustPosition, mod.DustType<Dusts.闪耀灰尘>(), null, 100, Color.Lime, 0.8f);
            dust.velocity *= 0.3f;
            dust.noGravity = true;
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                Dust dust = Dust.NewDustDirect(projectile.position - projectile.velocity, projectile.width, projectile.height, mod.DustType<Dusts.闪耀灰尘>(), 0, 0, 100, Color.Lime, 0.8f);
                dust.noGravity = true;
                dust.velocity *= 2f;
                dust = Dust.NewDustDirect(projectile.position - projectile.velocity, projectile.width, projectile.height, mod.DustType<Dusts.闪耀灰尘>(), 0f, 0f, 100, Color.Lime, 0.5f);
            }
        }
    }
}